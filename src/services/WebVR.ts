...
const WEBVR = {
	...
	createButton: function ( renderer, options ) {
		...
		function showEnterXR( /*device*/ ) {
			...
			button.onclick = function () {
				...
				if ( currentSession === null ) {
					...
					(navigator as Navigator).xr.requestSession( 'immersive-vr', sessionInit ).then( onSessionStarted );
		...
		if ( 'xr' in navigator && 'isSessionSupported' in navigator['xr'] ) {
			...
			(navigator as Navigator).xr.isSessionSupported( 'immersive-vr' ).then( function ( supported ) {
